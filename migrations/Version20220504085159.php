 ...
 */
final class Version20220504085159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE poll_message_seq INCREMENT BY 1 MINVALUE 1 START 1');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE poll_message_seq CASCADE');
